...
# Usage:
#   cti_protobuf_generate_cpp(<output_dir> <proto_srcs> <proto_hdrs> <proto_files>)
function(cti_protobuf_generate_cpp output_dir proto_srcs proto_hdrs)
  if(NOT ARGN)
    message(SEND_ERROR "Error: cti_protobuf_generate_cpp() called without any proto files")
    return()
  endif()
  ...
  foreach(fil ${ARGN})
    ...
    add_custom_command(
      ...
      ARGS --proto_path . --cpp_out ${output_dir} ${_protoc_include} ${abs_fil} 
      DEPENDS ${abs_fil}
